...
x = 0
# global = 1 - Jako identifikátory nemohou být použita klíčová slova
globall = 1
PI = 3.14
city = "Opava"
# hilda@sspu-opava.cz = 'Hilda Dokonalá'- Součástí identifikátorů nemohou být symboly jako např. [!@#$%] a další
hilda_sspu_opava_cz = 'Hilda Dokonalá'
password2 = 'TajneHeslo'
# 007agent = 'James Bond' - Identifikátory nemohou začínat numerickým znakem
agent007 = 'James Bond'
